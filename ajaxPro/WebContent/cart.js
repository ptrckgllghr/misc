...
/*
 * Adds the specified item to the shopping cart, via Ajax call itemCode -
...
/*
 * Update shopping-cart area of page to reflect contents of cart described in
 * XML document.
 */
function updateCart(cartXML) {
	...
	if (generated > lastCartUpdate) {
		...
		for ( var I = 0; I < items.length; I++) {
			...
			listItem.appendChild(document.createTextNode(name + " x "
					+ quantity));
